...
class _LoginPageState extends State<LoginPage> {
  ...
  void _validateUser() async {
    if (_email.text.isEmpty || _password.text.isEmpty) {
      ...
      String msg = "";
      if (result == "invalid-email") {msg = "El correo electónico está mal escrito";
      } else if (result == "wrong-password") {msg = "Correo o contrasena incorrecta";
      } else if (result == "network-request-failed") {msg = "Revise su conexion a internet";} else {
        msg = "Bienvenido";
        _showMsg(msg);
